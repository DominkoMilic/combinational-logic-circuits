...
const EXNOR = ({
  ...
  const handleEXNOR1InputCLick = (e) => {
    const inputNumber = 1;
    const newElement = {
  ...
  const handleEXNOR2InputCLick = (e) => {
    const inputNumber = 1;
    const newElement = {
  ...
  const handleEXNOR1OutputCLick = (e) => {
    const inputNumber = 2;
    const newElement = {
  ...
  return (
    ...
    >
      <div className="EXNOR handle" title={id} ref={draggableRef}>
        <div className="EXNOR-element">
          <div className="all-EXNOR-inputs">
            <div
              className="EXNOR-input"
              ref={(el) =>
                (inputRefs.current[0] = {
                  element: el,
                  id: "input1",
            ...
            <div
              ...
              onContextMenu={(e) => {
                e.preventDefault();
                handleEXNOR2InputCLick(e);
              }}
            ></div>
          </div>
          <div
            className="EXNOR-image"
            onContextMenu={(e) => {
              e.preventDefault();
              handleDeleteClick(e);
            }}
          ></div>
          <div className="all-EXNOR-outputs">
            <div
              className="EXNOR-output"
              ref={(el) =>
                (inputRefs.current[2] = {
                  element: el,
                  id: "output0",
