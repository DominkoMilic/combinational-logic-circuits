...
const EXOR = ({
  ...
  const handleEXOR1OutputCLick = (e) => {
    const inputNumber = 2;
    const newElement = {
  ...
  return (
    ...
    >
      <div className="EXOR handle" title={id} ref={draggableRef}>
        <div className="EXNOR-element">
          <div className="all-EXOR-inputs">
            <div
            ...
            <div
              ...
              onContextMenu={(e) => {
                e.preventDefault();
                handleEXOR2InputCLick(e);
              }}
            ></div>
          </div>
          <div
            className="EXOR-image"
            onContextMenu={(e) => {
              e.preventDefault();
              handleDeleteClick(e);
            }}
