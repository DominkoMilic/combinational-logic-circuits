    ...
    >
      <div className="NOR handle" title={id} ref={draggableRef}>
        <div className="NOR-element">
          <div className="all-NOR-inputs eight">
            <div
              className="NOR-input"
              ref={(el) =>
                (inputRefs.current[0] = {
            ...
            <div
              ...
              onContextMenu={(e) => {
                e.preventDefault();
                handleNOR8InputCLick(e);
              }}
            ></div>
          </div>
          <div
            className="NOR-image8"
            onContextMenu={(e) => {
              e.preventDefault();
              handleDeleteClick(e);
            }}
