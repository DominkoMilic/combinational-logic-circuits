...
function InfoScreen({ visible, setIsInfoVisible, isHelp }: InfoScreenProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[100]">
      <div className="bg-slate-800 rounded-lg w-[700px] max-w-[90vw] max-h-[80vh] overflow-y-auto relative">
        <button
          className="absolute top-3 right-3 bg-red-600 hover:bg-red-500 text-white w-7 h-7
